...
class SquareSkin extends StackPane {
    static final Image noughtImage = new Image(
            "https://icons.iconarchive.com/icons/pictogrammers/material/256/circle-outline-icon.png"
    );
    static final Image crossImage = new Image(
            "https://icons.iconarchive.com/icons/github/octicons/256/x-16-icon.png"
    );
